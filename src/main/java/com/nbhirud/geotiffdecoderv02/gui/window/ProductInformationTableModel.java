 ...
 * @author KPServer
 */
public class ProductInformationTableModel implements TableModel {

    private String columns[] = {"Product Information"};
    private Class<?> columnClass[] = {JPanel.class};
    private ArrayList<IGeoKeyInfo> geoKeyInfoList = new ArrayList<IGeoKeyInfo>();

    public ProductInformationTableModel(ArrayList<IGeoKeyInfo> geoKeyInfoList) {
